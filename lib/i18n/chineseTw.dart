const Map<String, String> chineseTwMap = {
  ...
  'saveFailedToast': '儲存失敗 請稍後再試一次',
  'pickSuccessToast': '成功加入精選',
  'pickFailedToast': '加入精選失敗',
  'unPickSuccessToast': '成功移除精選',
  'unPickFailedToast': '移除精選失敗',
  'addBookmarkSuccessToast': '成功加入書籤',
