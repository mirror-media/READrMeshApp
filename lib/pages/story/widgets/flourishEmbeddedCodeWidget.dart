...
class FlourishEmbeddedCodeWidget extends StatefulWidget {
  final String embeddedCode;
  final double? aspectRatio;

  const FlourishEmbeddedCodeWidget(
      {required this.embeddedCode, this.aspectRatio});

  @override
  _FlourishEmbeddedCodeWidgetState createState() =>
      _FlourishEmbeddedCodeWidgetState();
}

class _FlourishEmbeddedCodeWidgetState extends State<FlourishEmbeddedCodeWidget>
