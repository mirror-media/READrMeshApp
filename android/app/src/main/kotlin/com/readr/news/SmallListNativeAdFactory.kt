...
class SmallListNativeAdFactory(private val context: Context) : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val nativeAdView = LayoutInflater.from(context)
                .inflate(R.layout.small_list_native_ad, null) as NativeAdView

        with(nativeAdView) {
            val iconView = findViewById<ImageView>(R.id.native_ad_image)
